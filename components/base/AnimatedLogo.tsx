...
export default function AnimatedLogo({ width = 500, height = 347, className = '' }: AnimatedLogoProps) {
  return (
    <div className={`${styles.animatedLogo} ${className}`}>
      <svg
        width={width}
        height={height}
        viewBox="300 350 700 200"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className={styles.logoSvg}
      >
        {/* Logo Symbol (Chevron) with animations */}
        <g className={styles.logoSymbol}>
          <polygon
            className={`${styles.symbolPart} ${styles.symbolRight}`}
            fill="#02BF76"
            points="469.65 419.77 497.54 447.67 489.37 455.84 469.49 435.96 469.65 419.77"
          />
          <polygon
            className={`${styles.symbolPart} ${styles.symbolLeft}`}
            fill="#00EA96"
            points="469.65 419.77 441.75 447.67 449.93 455.84 469.81 435.96 469.65 419.77"
          />
          <rect
            className={`${styles.symbolPart} ${styles.symbolBase}`}
            fill="#00CE84"
            x="441.43"
            y="464.54"
            width="56.43"
        ...
        {/* "earn" text */}
        <g className={`${styles.logoText} ${styles.textEarn}`}>
          <path
            className={styles.earnText}
            fill="#FFFFFF"
        ...
        {/* "prime" text */}
        <g className={`${styles.logoText} ${styles.textPrime}`}>
          <path
            fill="#00CE83"
          ...
          <path
            fill="#00CE83"
            d="m826.9,453.3c.65,3.35,2.19,5.95,4.61,7.8,2.43,1.85,5.41,2.78,8.97,2.78,4.95,0,8.55-1.83,10.81-5.48l5.55,3.15c-3.65,5.65-9.15,8.48-16.51,8.48-5.95,0-10.79-1.86-14.52-5.59-3.73-3.73-5.59-8.44-5.59-14.14s1.82-10.35,5.48-14.11c3.65-3.75,8.38-5.63,14.18-5.63,5.5,0,9.99,1.94,13.47,5.82,3.48,3.88,5.21,8.54,5.21,13.99,0,.95-.08,1.93-.22,2.93h-31.44Zm12.98-16.58c-3.5,0-6.4.99-8.7,2.96-2.3,1.98-3.73,4.61-4.28,7.92h25.06c-.55-3.55-1.95-6.25-4.2-8.1-2.25-1.85-4.88-2.78-7.88-2.78Z"
          />
        </g>
      </svg>
    </div>
